        ...
        a = function(e, o) {
            ...
            if (0 !== t(".woocommerce-cart-form").length) {
                if (o || t(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), 0 === i.length) {
                    ...
                    t(".woocommerce-cart-form__contents").closest(".woocommerce").replaceWith(p), s.length > 0 && n(s, t(".cart-empty").closest(".woocommerce"))
                } else t(".woocommerce-checkout").length && t(document.body).trigger("update_checkout"), t(".woocommerce-cart-form").replaceWith(i), t(".woocommerce-cart-form").find('input[name="update_cart"]').prop("disabled", !0), s.length > 0 && n(s), r(a);
        ...
        p = {
            ...
            apply_coupon: function(o) {
                ...
                t.ajax({
                    type: "POST",
                    headers: {
                        'X-CSRF-TOKEN': wc_cart_params.token
                    },
                    url: e("apply_coupon"),
                    data: p,
                    dataType: "html",
                    success: function(e) {
                        t(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), n(e), t(document.body).trigger("applied_coupon", [s])
                    },
                    complete: function() {
            ...
            remove_coupon_clicked: function(o) {
                ...
                t.ajax({
                    ...
                    dataType: "html",
                    success: function(e) {
                        t(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), n(e), t(document.body).trigger("removed_coupon", [s]), i(r)
                    },
                    complete: function() {
                        a.update_cart(!0)
                    }
            ...
            item_remove_clicked: function(e) {
                ...
                var o = t(e.currentTarget),
                    r = o.parents("form");
                c(r), c(t("div.cart_totals")), t.ajax({
                    type: "GET",
                    url: o.attr("href"),
                    dataType: "html",
                    success: function(t) {
