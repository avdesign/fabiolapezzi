...
@push('title')
<title>Rastrear Ordem {{config('app.name')}} {{$configKeyword->description}} </title>
...
@push('body')
<body class="page-template-default page page-id-4367 logged-in yith-wcan-free has-btn-sticky wpb-js-composer js-comp-ver-5.2.1 vc_responsive"  itemscope="itemscope" itemtype="http://schema.org/WebPage" >
@endpush
@section('content')
    <div id="jas-content">
        <div class="page-head pr tc" style="background: url({{asset('assets/imagens/home/banners/cadastro.jpg')}}) no-repeat center center / cover;">
            <div class="jas-container pr">
                <h1 class="tu mb__10 cw"  itemprop="headline" >Rastreamento de ordens</h1>
                <ul class="jas-breadcrumb dib oh">
                    <li class="fl home">
                        <a href="{{route('home.site')}}" title="Home">Home</a>
                    </li>
                    <li class="fl separator">
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li class="fl current"> Rastreamento de ordens </li>
                </ul>
            </div>
        </div>
                                        ...
                                        <div class="wpb_text_column wpb_content_element " >
                                            <div class="wpb_wrapper">
                                                <div class="woocommerce">
                                                    ...
                                                    <form action="{{route('track.info')}}" method="post" class="track_order">
                                                        <p>Para acompanhar o seu pedido, insira o número do pedido na caixa abaixo e pressione o botão "Rastrear".</p>
                                                        <p>Isso foi dado a você em seu recibo e no email de confirmação que você deve ter recebido.</p>

                                                        <p class="form-row form-row-first">
                                                            <label for="orderid">Número do Pedido</label>
                                                            <input class="input-text" type="text" name="order_id" id="order_id" placeholder="Encontrado no email de confirmação do seu pedido." />
                                                        </p>
                                                        <p class="form-row form-row-last">
                                                            <label for="order_email">Seu email</label>
                                                            <input class="input-text" type="text" name="email" id="order_email" placeholder="Seu Email" />
                                                        </p>
                                                        <div class="clear"></div>
                                                        <p class="form-row">
                                                            <button type="submit" id="form-track-submit" onclick="postFormJson(jQuery(this.form).attr('id'));" class="button">Rastrear</button>
                                                        </p>
                                                        {{csrf_field()}}
                                                    </form>
                                                </div>
