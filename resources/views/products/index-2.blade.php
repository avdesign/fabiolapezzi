                        ...
                        <div class="jas-col-md-6 jas-col-sm-5 jas-col-xs-12">
                            ...
                            <div class="summary entry-summary">
                                ...
                                <div class="flex between-xs middle-xs price-review">
                                    <p class="price">
                                        R$ à vista
                                        <span class="cash">{{setReal($price_cash)}}</span> -
                                        {{$product->kit_name}}
                                        <span class="cash">{{setReal($price_cash * $product->unit)}}</span>
                                        <br>
                                        R$ parcelado
                                        <span class="card">{{setReal($price_card)}}</span> -
                                        {{$product->kit_name}}
                                        <span class="card">{{setReal($price_card * $product->unit)}}</span>
                                    </p>
                                </div>
                                        ...
                                        <div class="variations">
                                            <div class="swatch is-color">
                                                ...
                                                <ul class="swatch__list is-flex" data-attribute="pa_color">
                                                    @foreach ($product->images as $color)
                                                        <li data-variation="{{$color->color}}" data-image-id="{{$color->id}}" data-grid="kit_sizes" class="swatch__list--item is-relative">
                                            ...
                                            <div id="kit_sizes" class="swatch is-label">
