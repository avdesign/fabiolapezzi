...
<link rel="stylesheet" id="contact-form-7-css" href="{{asset('avdesign/plugins/contact-form-7/css/styles.css')}}" type="text/css" media="all" />
<link rel="stylesheet" id="avd-product-bundle-css" href="{{asset('avdesign/plugins/avd-product-bundle/assets/css/frontend.css')}}" type="text/css" media="all" />
<link rel="stylesheet" id="avd-variation-swatch-css" href="{{asset('avdesign/plugins/avd-variation-swatch/assets/css/frontend.css')}}" type="text/css" media="all" />

<link rel="stylesheet" id="ypop_icon-retinaicon-font-css" href="{{asset('avdesign/plugins/yith-avd-popup/assets/fonts/retinaicon-font/style.css')}}" type="text/css" media="all" />
<link rel="stylesheet" id="ypop_frontend-css" href="{{asset('avdesign/plugins/yith-avd-popup/assets/css/frontend.css')}}" type="text/css" media="all" />
<link rel="stylesheet" id="ypop_style-css" href="{{asset('avdesign/plugins/yith-avd-popup/assets/css/style.css')}}" type="text/css" media="all" />
<link rel="stylesheet" id="ypop_style-css" href="{{asset('avdesign/plugins/yith-avd-popup/assets/css/theme1.css')}}" type="text/css" media="all" />

<link rel="stylesheet" id="avd-prettyPhoto-css" href="{{asset('avdesign/plugins/prettyPhoto/css/prettyPhoto.css')}}" type="text/css" media="all" />
<link rel="stylesheet" id="jquery-selectBox-css" href="{{asset('avdesign/plugins/yith-avd-wishlist/assets/css/jquery.selectBox.css')}}" type="text/css" media="all" />
<link rel="stylesheet" id="yith-avd-wishlist-css" href="{{asset('avdesign/plugins/yith-avd-wishlist/assets/css/style.css')}}" type="text/css" media="all" />
...
<script type="text/javascript" src="{{asset('avdesign/plugins/cart/assets/js/frontend/add-to-cart.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/plugins/js_composer/assets/js/vendors/avd-add-to-cart.js')}}"></script>

<script type="text/javascript" src="{{asset('avdesign/plugins/yith-avd-popup/assets/js/jquery.cookie.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/plugins/yith-avd-popup/assets/js/jquery.yitpopup.min.js')}}"></script>
<script type='text/javascript'>
    /* <![CDATA[ */
...
<script type="text/javascript" src="{{asset('avdesign/plugins/yith-avd-popup/assets/js/frontend.min.js')}}"></script>

@stack('meta')
<meta itemprop="name" content="">
<meta itemprop="description" content="">
<meta itemprop="image" content="http://janstudio.net/claue/demo/wp-includes/images/media/default.png">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@Claue">
<meta name="twitter:title" content="">
<meta name="twitter:description" content="">
<meta name="twitter:creator" content="@Claue">
<meta name="twitter:image:src" content="http://janstudio.net/claue/demo/wp-includes/images/media/default.png">
<meta property="og:title" content="" />
<meta property="og:url" content="" />
<meta property="og:image" content="http://janstudio.net/claue/demo/wp-includes/images/media/default.png" />
<meta property="og:image:url" content="http://janstudio.net/claue/demo/wp-includes/images/media/default.png" />
<meta property="og:description" content="" />
<meta property="og:site_name" content="Claue" />
...
<!--[if lte IE 9]>
    <link rel="stylesheet" type="text/css" href="http://janstudio.net/claue/demo/wp-plugins/js_composer/assets/css/vc_lte_ie9.min.css" media="screen">
<![endif]-->
...
<body class="error404 logged-in yith-wcan-free wpb-js-composer js-comp-ver-5.2.1 vc_responsive" itemscope="itemscope" itemtype="http://schema.org/WebPage">
@stack('body')
<div id="jas-wrapper">
        ...
        <div class="jas-container">
            <section class="error-404 not-found">
                <div id="content-wrapper">
                    ...
                    <p>Go back to the <a href="http://janstudio.net/claue/demo/" rel="home">homepage</a></p>
                </div>
            </section>
        </div>
    </div>
...
<script type="text/javascript" src="{{asset('avdesign/plugins/default/assets/js/jquery-blockui/jquery.blockUI.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/plugins/default/assets/js/js-cookie/js.cookie.min.js')}}"></script>
<script type="text/javascript">
    /* <![CDATA[ */
    var woocommerce_params = {
        "ajax_url": "\/claue\/demo\/wp-admin\/admin-ajax.php",
        "wc_ajax_url": "\/claue\/demo\/shop3?wc-ajax=%%endpoint%%"
    };
    /* ]]> */
</script>
<script type="text/javascript" src="{{asset('avdesign/plugins/default/assets/js/frontend/avdesign.min.js')}}"></script>
...
<script type='text/javascript'>
    ...
    var wc_cart_fragments_params = {!! json_encode([
            ...
            "fragment_name" => "avd_fragments",
        ]) !!};
</script>

<script type="text/javascript" src="{{asset('avdesign/plugins/cart/assets/js/frontend/cart-fragments.min.js')}}"></script>
<script type="text/javascript">
    /* <![CDATA[ */
    var wpa_wcpb = {
...
<script type="text/javascript" src="{{asset('avdesign/plugins/avd-product-bundle/assets/js/frontend.js')}}"></script>
<script type="text/javascript">
    /* <![CDATA[ */
    var wpa_wcvs = {
        "ajaxurl": "http:\/\/janstudio.net\/claue\/demo\/wp-admin\/admin-ajax.php",
...
<script type="text/javascript" src="{{asset('avdesign/plugins/avd-variation-swatch/assets/js/frontend.js')}}"></script>

<script type="text/javascript" src="{{asset('avdesign/plugins/prettyPhoto/js/prettyPhoto.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/plugins/yith-avd-wishlist/assets/js/jquery.selectBox.min.js')}}"></script>
<script type="text/javascript">
    /* <![CDATA[ */
    var yith_wcwl_l10n = {
        "ajax_url": "\/claue\/demo\/wp-admin\/admin-ajax.php",
...
<script type="text/javascript" src="{{asset('avdesign/plugins/yith-avd-wishlist/assets/js/jquery.yith-wcwl.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/content/themes/white/assets/vendors/slick/slick.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/content/themes/white/assets/vendors/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/plugins/js_composer/assets/lib/bower/isotope/dist/isotope.pkgd.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/content/themes/white/scrollreveal/scrollreveal.min.js')}}"></script>
<script type="text/javascript" src="{{asset('avdesign/content/themes/white/jquery-countdown/jquery.countdown.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('avdesign/plugins/cart/assets/js/frontend/add-to-cart-variation.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('avdesign/content/themes/white/js/theme.js')}}"></script>
<script type="text/javascript">
...
<script type="text/javascript">
    ...
    var mailchimp_localization = {
        "url": "http:\/\/janstudio.net\/claue\/demo\/wp-admin\/admin-ajax.php",
        "error_message": "Ops! Something went wrong"
    };
    /* ]]> */
</script>
<script type="text/javascript" src="{{asset('avdesign/plugins/yith-avd-popup/assets/js/mailchimp-ajax-subscribe.js')}}"></script>
<script>
    (function($) {
        "use strict";
