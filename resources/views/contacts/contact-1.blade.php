...
@push('title')
<title>Contato {{config('app.name')}} {{$configKeyword->description}} </title>
        ...
        <div class="jas-row jas-page">
            <div class="jas-col-md-12 jas-col-xs-12 mt__60 mb__60" role="main" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
                <div class="vc_row home-contact-us-form pr vc_custom_1463925630553 vc_row-has-fill"
                     style="background-image: url('{{asset('assets/imagens/contato/contato-bg.jpg')}}') !important; background-position:center center!important;">
                                    ...
                                    <div class="vc_row vc_inner">
                                        <div class="wpb_column vc_column_container vc_col-sm-8 vc_col-has-fill">
                                            <div class="vc_column-inner vc_custom_1460194003865">
                                                <div class="wpb_wrapper">
                                                    <div class="jas-gmap" id="jas_map_59e010595601c" style="max-width:780px;width:100%;height:580px;"></div>
                                                    <script>
                                                        var map;
                                                        function initMap() {
                                            ...
                                            <div class="vc_column-inner vc_custom_1460194202292">
                                                <div class="wpb_wrapper">
                                                    <div role="form" class="wpcf7" id="wpcf7-f4106-p2862-o1" lang="en-US" dir="ltr">
                                                        ...
                                                        <form action="{{route('contact')}}" method="post" class="wpcf7-form" id="form-contact" onsubmit="return false">
                                                            <div style="display: none;">
                                                                <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                                            </div>
                                                            <h3 class="section-title" style="margin-bottom: 15px; text-align: left; font-size: 18px">FORMULÁRIO PARA CONTATO</h3>
                                                            <p>
                                                                <label for="subject" class="">Assunto
                                                                    <abbr class="required" title="Obrigatório">*</abbr>
                                                                </label>
                                                                <select id="subject" name="subject_id" class="wpcf7-form-control-wrap">
                                                            ...
                                                            <p>
                                                                <span class="wpcf7-form-control-wrap">
                                                                    @auth
                                                                        <input type="text" name="name" value="{{ Auth::user()->first_name }}" placeholder="Seu nome" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required w__100" aria-required="true" aria-invalid="false" />
                                                                    @else
                                                                        <input type="text" name="name" value="" placeholder="Seu nome" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required w__100" aria-required="true" aria-invalid="false" />
                                                                    @endauth
                                                                </span>
                                                            </p>
                                                            <p>
                                                                <span class="wpcf7-form-control-wrap">
                                                                    @auth
                                                                        <input type="email" name="email" value="{{ Auth::user()->email }}" placeholder="Seu email" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required w__100" aria-required="true" aria-invalid="false" />
                                                                    @else
                                                                        <input type="email" name="email" value="" placeholder="Seu email" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required w__100" aria-required="true" aria-invalid="false" />
                                                                    @endauth
                                                                </span>
                                                            </p>
                                                            <p>
                                                                <span class="wpcf7-form-control-wrap">
                                                                    @auth
                                                                        <input type="text" name="cell" value="{{ Auth::user()->cell }}" placeholder="Seu celular" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required w__100" aria-required="true" aria-invalid="false" />
                                                                    @else
                                                                        <input type="text" id="cell" name="cell" value="" placeholder="Seu Celular" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required w__100" aria-required="true" aria-invalid="false" />
                                                                    @endauth
                                                                </span>
                                                            </p>
                                                            <p>
                                                                <span class="wpcf7-form-control-wrap">
                                                                    <textarea placeholder="Mensagem:" name="message" cols="40" rows="10" maxlength="140" minlength="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required w__100" aria-required="true" aria-invalid="false"></textarea>
                                                                </span>
                                                            </p>
                                                            @guest
                                                                <p>
                                                                    <input type="checkbox" class="input-checkbox" name="newsletter" checked>
                                                                    <label for="terms" class="checkbox"></label>
                                                                    <span>Quero me inscrever para receber ofertas e descontos exclusivos.</span>
                                                                </p>
                                                            @else
                                                                <p>Você pode acompanhar o retorno através da sua página administrativa "Mensagens"</p>
                                                            @endguest
                                                            <p style="margin-bottom: 0">
                                                                <button type="submit" id="form-contact-submit" onclick="postFormJson(jQuery(this.form).attr('id'));" class="wpcf7-form-control wpcf7-submit w__100 button-o fr">Enviar</button>

                                                            </p>
                                                            <div id="return-form-contact" style="display:none"></div>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
