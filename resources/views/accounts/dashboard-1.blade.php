...
@push('title')
<title>Minha Conta {{config('app.name')}} {{$configKeyword->description}} </title>
                ...
                <div class="jas-col-md-12 jas-col-xs-12 mt__60 mb__60" role="main" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
                    <div class="woocommerce">
                        <nav class="woocommerce-MyAccount-navigation">
                            <ul>
                                <li class="woocommerce-MyAccount-navigation-link woocommerce-MyAccount-navigation-link--dashboard is-active">
                                    <a href="javascript:void(0);">Painel Administrativo</a>
                                </li>
                        ...
                        <div class="woocommerce-MyAccount-content">
                            ...
                            <p>Olá <strong>{{ $user->first_name }}</strong> (não é  <strong>{{ $user->first_name }}</strong>?
                                <a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form-account').submit();">Sair</a>)
                            </p>

                            <p>
                                No painel da sua conta, você pode visualizar seus
                                <a href="{{ route('orders') }}">pedidos recentes</a>, alterar seu
                                <a href="{{ route('address') }}"> endereço de entrega</a> e
                                <a href="{{ route('edit') }}">editar sua senha e detalhes da conta.</a>.
                            </p>
