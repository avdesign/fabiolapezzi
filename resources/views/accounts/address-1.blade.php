                ...
                <div class="jas-col-md-12 jas-col-xs-12 mt__60 mb__60" role="main" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
                    <div class="woocommerce">
                        ...
                        <div class="woocommerce-MyAccount-content">
                            <p>Este endereço será usado para envio dos pedidos, você deve mantê-lo sempre atualizado.<p>
                            ...
                            <div class="u-columns woocommerce-Addresses col2-set addresses">
                                ...
                                <div class="u-column1 col-1 woocommerce-Address">
                                    <header class="woocommerce-Address-title title">
                                        ...
                                        <a href="{{route('address.update')}}" class="edit">Atualizar</a>
                                    </header>
                                    <address>
                                        Endereço: <b>{{$adresses->address}}</b><br/>
                                        Número: <b>{{$adresses->number}}</b><br/>
                                        Complemento: <b>{{$adresses->complement}}</b><br/>
                                        Bairro: <b>{{$adresses->district}}</b><br/>
                                        Cidade: <b>{{$adresses->city}}</b><br/>
                                        Estado: <b>{{$adresses->state}}</b><br/>
                                        CEP: {{$adresses->zip_code}}
                                    </address>
                                </div>
                            </div>
