...
@push('title')
<title>Meus Pedidos {{config('app.name')}} {{$configKeyword->description}} </title>
...
@endpush
@push('meta')
<link rel="canonical" href="{{route('orders')}}" />
    ...
    <div id="jas-content">
        <div class="page-head pr tc" style="background: url({{asset('assets/imagens/home/banners/cadastro.jpg')}}) no-repeat center center / cover;">
            <div class="jas-container pr">
                <h1 class="tu mb__10 cw" itemprop="headline">Meus Pedidos</h1>
                <p></p>
                <ul class="jas-breadcrumb dib oh">
                    <li class="fl home">
                        <a href="{{route('home.site')}}" title="Home">Home</a></li>
                    <li class="fl separator"> <i class="fa fa-angle-right"></i> </li>
                    <li class="fl current"> Meus Pedidos</li>
                </ul>
            </div>
        </div>
                            ...
                            <table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><span class="nobr">Ações</span></th>
                                    </tr>
                                </thead>
                                ...
                                <tr>
                                    <td><a href="#">#4885</a></td>
                                    <td><time datetime="2017-10-12T19:56:20+00:00">12 de Novembro, 2017</time></td>
                                    <td>Verificando</td>
                                    <td><span>R$ 300.00</span> para 4 itens</td>
                                    <td><a href="#" class="woocommerce-button button view">Ver</a> </td>
                                </tr>
                                <tr>
                                    <td><a href="#">#54542</a></td>
                                    <td><time datetime="2017-10-12T19:56:20+00:00">12 de Novembro, 2017</time></td>
                                    <td>Verificando</td>
                                    <td><span>R$ 300.00</span> para 4 itens</td>
                                    <td><a href="#" class="woocommerce-button button view">Ver</a> </td>
