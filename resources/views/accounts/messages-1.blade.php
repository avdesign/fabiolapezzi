...
@push('title')
<title>Minhas Mensagens {{config('app.name')}} {{$configKeyword->description}} </title>
...
@endpush
@push('styles')
<link rel="stylesheet" id="avd-data-tables" type="text/css" href="{{asset('assets/avd-content/plugins/data-tables/css/datatables.min.css')}}"/>
...
@endpush
@push('meta')
<link rel="canonical" href="{{route('messages')}}" />
    ...
    <div id="jas-content">
        <div class="page-head pr tc" style="background: url({{asset('assets/imagens/home/banners/cadastro.jpg')}}) no-repeat center center / cover;">
            <div class="jas-container pr">
                <h1 class="tu mb__10 cw" itemprop="headline">Minhas Mensagens</h1>
                <p></p>
                <ul class="jas-breadcrumb dib oh">
                    <li class="fl home">
                        <a href="{{route('home.site')}}" title="Home">Home</a></li>
                    <li class="fl separator"> <i class="fa fa-angle-right"></i> </li>
                    <li class="fl current"> Minhas Mensagens</li>
                </ul>
            </div>
        </div>
                ...
                <div class="jas-col-md-12 jas-col-xs-12 mt__60 mb__60" role="main" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
                    <div class="woocommerce">
                        ...
                        <div class="woocommerce-MyAccount-content">
                            <table id="messages" class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
                                <thead>
                                    <tr>
                                        <th><span class="nobr">Ticket</span></th>
                                        <th><span class="nobr">Asunto</span></th>
                                        <th><span class="nobr">Mensagem</span></th>
                                        <th><span class="nobr">Retorno</span></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
@endsection
@push('scripts')
<script type="text/javascript" src="{{asset('assets/avd-content/plugins/data-tables/js/datatables.min.js')}}"></script>
<script>
